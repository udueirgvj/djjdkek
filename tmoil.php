<?php 
ob_start();
#تم كتابة وتطوير هذا الملف من قبل المطور 
# wathq 
# CH : @YYPYY7
# TELE : @WATAW
#انشر واستفيد بس لا تغير الحقوق 
#تحب تشكرني على الملف ادعي لي 💜

$token = "7174012233:AAFV9Geosx33O6wvtK_6StMon8A7C6Hcv38"; # Token
...
$sudo = array("6001517585");
$wathq1 = 6001517585; 
$sudo = 1961153456; // ايديك
mkdir("sudo");
mkdir("data");
